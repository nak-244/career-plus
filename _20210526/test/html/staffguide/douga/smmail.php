...
--------------------------------------------------------------*/
// 設定
$mail_to = 'navi@aspaywork.jp'; // フォームデータを受け取るメールアドレス
$mail_subject = 'スタッフガイド完了報告：株式会社アスペイワーク'; // 受け取る時のSubject（件名）
$reply_subject = '完了報告ありがとうございました：株式会社アスペイワークより自動返信です'; // 送信者へ自動返信のSubject（件名）
