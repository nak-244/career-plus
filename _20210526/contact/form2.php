...
<title>お問い合わせフォーム（法人のお客様） |【公式】株式会社キャリアプラス - 日払い対応人材派遣サービス</title>
<div id="main">
<div id="main-all">
<!--/トップ固定-->
...
// 運営側へ送るメールの件名
$admin_reply_subject = "【CAP】お問い合わせ（法人）を受け付けました";
...
if(document.form_sp.com_name.value == ""){
flag = 1;
}
else if(document.form_sp.com_name2.value == ""){
flag = 1;
}
else if(document.form_sp.your_name.value == ""){
flag = 1;
}
...
<label class="kakunin">■会社名</label>
<p><?php echo $_POST['com_name']; ?></p>
</div><!--/element_wrap-->

<div class="element_wrap">
<label class="kakunin">■会社名（フリガナ）</label>
<p><?php echo $_POST['com_name2']; ?></p>
</div><!--/element_wrap-->
...
<input type="hidden" name="com_name" value="<?php echo $_POST['com_name']; ?>">
<input type="hidden" name="com_name2" value="<?php echo $_POST['com_name2']; ?>">
...
<?php else: ?><!--入力ページ-->
<h2>お問い合わせ入力フォーム<br><span>（法人のお客様）</span></h2>
<div class="content">
...
<input type="text" name="com_name" value="" required>
</div>
...
<div class="element_right">
<input type="text" name="com_name2" value="" required>
</div>
<div style="clear:both;"></div>
</div><!--/element_wrap-->
